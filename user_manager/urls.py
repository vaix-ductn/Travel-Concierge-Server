...
urlpatterns = [
    ...
    path('profile/<uuid:profile_uuid>/delete/', user_profile.delete_user_profile, name='delete_profile'),  # Delete specific profile
    path('profile/<uuid:profile_uuid>/ai-context/', user_profile.get_user_ai_context, name='get_ai_context'),  # Get AI context for profile
    path('profile/<uuid:profile_uuid>/summary/', user_profile.get_user_profile_summary, name='get_profile_summary'),  # Get profile summary
]