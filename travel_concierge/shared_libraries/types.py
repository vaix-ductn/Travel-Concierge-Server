...
class POI(BaseModel):
    ...
    map_url: Optional[str] = Field(
        description="Direct Google Maps URL for navigation (e.g., https://www.google.com/maps/place/?q=place_id:ChIJLU7jZClu5kcR4PcOOO6p3I0). Auto-populated by map_tool after POI generation."
    )
    place_id: Optional[str] = Field(
        description="Unique Google Places API identifier (e.g., ChIJLU7jZClu5kcR4PcOOO6p3I0). Auto-populated by map_tool after POI generation."
    )
